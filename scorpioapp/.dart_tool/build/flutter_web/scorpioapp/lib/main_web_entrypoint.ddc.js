define(['dart_sdk', 'packages/scorpioapp/database'], function(dart_sdk, packages__scorpioapp__database) {
  'use strict';
  ...
  const main = packages__scorpioapp__database.main;
  ...
  dart.trackLibraries("packages/scorpioapp/main_web_entrypoint", {
    "package:scorpioapp/main_web_entrypoint.dart": main_web_entrypoint
  }, {

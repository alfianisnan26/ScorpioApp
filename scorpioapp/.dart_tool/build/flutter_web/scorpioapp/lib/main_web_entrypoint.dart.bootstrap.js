...
let modulePaths = {
 ...
 "packages/hex/hex": "packages/hex/hex.ddc",
 ...
 "packages/scorpioapp/database": "packages/scorpioapp/database.ddc",
 "packages/scorpioapp/main_web_entrypoint": "packages/scorpioapp/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/scorpioapp/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:scorpioapp/main_web_entrypoint.dart") {
          // Clear static caches.
